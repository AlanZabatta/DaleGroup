defmodule DaleAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DaleAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DaleAppWeb.Gettext, "errors", msg, opts)
    end
  end
