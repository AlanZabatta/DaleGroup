defmodule DaleApp.Products.IncidenciasStock do
  ...
  - si no: 3 puntos si resuelve dentro de las primeras 24hs desde que aparecio
           2 puntos si resuelve entre 24 y 48hs
           1 punto si resuelve despues de 48hs
  """
  ...
  def abrir(brand_id, product_id, tipo, codigo_talle \\ nil) do
    ya_abierta =
      Repo.exists?(
